...
public:
	...
	void(*m_pBackgroundPaint)(CDC*,RECT,BOOL,DWORD,CBitmap*);	// background drawing function
   ...
   CBitmap *m_pBitmapBack;
	...
	static void DrawBackground(CDC *pDC, RECT rect, BOOL bAnimate, DWORD lParam,CBitmap *pBitMap);
	// drawing routines
